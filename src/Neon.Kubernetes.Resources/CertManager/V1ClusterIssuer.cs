...
namespace Neon.K8s.Resources.CertManager
{
    ...
    [Ignore]
    public class V1ClusterIssuer : IKubernetesObject<V1ObjectMeta>, ISpec<V1IssuerSpec>, IValidate
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the V1ClusterIssuer class.
        /// </summary>
        /// 
        public V1ClusterIssuer()
        {
